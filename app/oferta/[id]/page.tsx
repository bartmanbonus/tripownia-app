...
export async function generateMetadata({params}:{params:Promise<{id:string}>}):Promise<Metadata>{
  ...
  return o?{title:`${o.city} od ${o.price} zł | Tripownia`,description:o.reason}:{};
}
      ...
      <section className="detail-hero">
        ...
        <div className="detail-copy">
          ...
          <a className="primary-cta" href={o.affiliateUrl} target="_blank" rel="sponsored noopener noreferrer">
            Sprawdź aktualną cenę u {p.name} <ExternalLink size={18}/>
          </a>
          <small className="affiliate-note">Dopiero ten przycisk prowadzi poza Tripownię. Cena i dostępność mogą się zmienić.</small>
        </div>
      </section>
    </div>
    <SiteFooter/>
