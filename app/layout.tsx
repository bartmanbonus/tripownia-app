...
export const metadata: Metadata = {
  ...
  description: "Codziennie wybieramy konkretne okazje, city breaki, wakacje i podróże po przeżyciach. Dodatkowo możesz samodzielnie przeszukać oferty partnerów.",
