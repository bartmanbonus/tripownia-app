...
const moods = [
  {
    ...
    kicker: "DOBRA CENA",
    title: "Ciepło teraz",
    text: "Kierunki, które dziś mają sens cenowo i pogodowo.",
  ...
  },
  {
    ...
    text: "Zorza, sakura, fiordy, safari i inne wyjazdy, które pamięta się latami.",
  ...
  },
  {
    ...
    kicker: "DALEKO",
    title: "Egzotyka i inne kontynenty",
    text: "Azja, Afryka, Ameryki i wyspy — kiedy chcesz naprawdę zmienić otoczenie.",
  ...
  },
  {
    ...
    title: "Mecz + miasto",
    text: "Wybierz spotkanie, a Tripownia pomoże dołożyć lot i nocleg.",
