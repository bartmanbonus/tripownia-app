...
type Experience = { id:string; icon:string; window:string; title:string; lead:string; image:string; ideas:Idea[] };

const experiences: Experience[] = [
  { id:"zorza", image:EXPERIENCE_IMAGES.zorza, icon:"🌌", window:"15 września – 31 marca", title:"Zorza polarna", lead:"Największą szansę dają długie, ciemne noce. Zamiast jednej daty pokazujemy całe okno, w którym naprawdę warto polować na zorzę.", ideas:[
  ...
  { id:"sakura", image:EXPERIENCE_IMAGES.sakura, icon:"🌸", window:"20 marca – 15 kwietnia", title:"Sakura w Japonii", lead:"Kwitnienie przesuwa się co roku i różni między regionami. Najbezpieczniej planować podróż w szerokim oknie i dopiero później dopinać konkretne miasta.", ideas:[
  ...
  { id:"fiordy", image:EXPERIENCE_IMAGES.fiordy, icon:"🏔️", window:"15 maja – 15 września", title:"Fiordy i długie dni", lead:"To okres z najdłuższym dniem, lepszą dostępnością tras i największym wyborem rejsów oraz trekkingów.", ideas:[
  ...
  { id:"nowa-zelandia", image:EXPERIENCE_IMAGES.nowa_zelandia, icon:"🥾", window:"listopad – marzec", title:"Nowa Zelandia — lato i road trip", lead:"Gdy w Polsce jest zima, w Nowej Zelandii trwa lato. To najlepsze okno na road trip, szlaki, fiordy i długie dni na trasie.", ideas:[
  ...
  { id:"tulipany", image:EXPERIENCE_IMAGES.tulipany, icon:"🌷", window:"1 kwietnia – 10 maja", title:"Tulipany w Holandii", lead:"Najlepszy efekt jest zwykle od połowy kwietnia do początku maja, ale dokładny moment zależy od pogody.", ideas:[
  ...
  { id:"safari", image:EXPERIENCE_IMAGES.safari, icon:"🦁", window:"15 czerwca – 31 października", title:"Safari — Kenia i Tanzania", lead:"Pora sucha daje łatwiejsze obserwacje zwierząt i lepsze warunki na objazd parków. W środku tego okna można dopiero polować na konkretny termin.", ideas:[
  ...
  { id:"wieloryby", image:EXPERIENCE_IMAGES.fiordy, icon:"🐋", window:"kwiecień – październik", title:"Wieloryby i ocean", lead:"Sezon zależy od akwenu, dlatego pokazujemy kierunki, w których obserwacje mają sens przez dłuższe okno, a nie jeden przypadkowy weekend.", ideas:[
  ...
  { id:"egzotyka", image:EXPERIENCE_IMAGES.egzotyka, icon:"🌴", window:"listopad – marzec", title:"Egzotyka w porze suchej", lead:"Gdy w Polsce jest zima, wybieramy miejsca z lepszym sezonem pogodowym — bez wciskania kierunku tylko dlatego, że jest tani.", ideas:[
