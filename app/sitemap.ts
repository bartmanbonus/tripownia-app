...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url:`${BASE_URL}/atrakcje`,lastModified:EVERGREEN_UPDATED,changeFrequency:"weekly",priority:.75 },
    { url:`${BASE_URL}/loty`,lastModified:STATIC_UPDATED,changeFrequency:"daily",priority:.8 },
    { url:`${BASE_URL}/hotele`,lastModified:STATIC_UPDATED,changeFrequency:"daily",priority:.8 },
