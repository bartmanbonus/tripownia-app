    ...
    <main className="long-haul-page">
      ...
      <section className="section shell">
        <div className="long-haul-list">
          {trips.map(trip => (
            <article className={`long-haul-detail-card ${trip.image ? "has-image" : ""}`} id={trip.id} key={trip.id}>
              {trip.image && (
                <div className="long-haul-detail-image">
                  <img src={trip.image} alt={`${trip.title} — inspiracja podróżnicza`} loading="lazy" decoding="async"/>
                </div>
              )}
