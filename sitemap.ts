...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/magazyn-podrozniczy`, lastModified: now, changeFrequency: "weekly", priority: 0.65 },
    { url: `${BASE_URL}/magazyn-podrozniczy/city-break-2026`, lastModified: now, changeFrequency: "monthly", priority: 0.55 },
    ...
    { url: `${BASE_URL}/wydarzenia`, lastModified: now, changeFrequency: "daily", priority: 0.9 },
    ...
    { url: `${BASE_URL}/informacja-afiliacyjna`, lastModified: now, changeFrequency: "monthly", priority: 0.4 },
