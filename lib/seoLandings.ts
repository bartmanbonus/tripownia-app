...
export const seoLandings: SeoLanding[] = [
  {
    ...
    lead: "Aktualne propozycje na Maltę z Warszawy i Modlina. Najpierw pokazujemy oferty Tripowni, niżej loty, noclegi i pakiety u partnerów.",
    query: "Malta",
    kiwiCode: "MLA",
    departure: "Warszawa",
    departureCode: "WAW",
  ...
  },
  {
    ...
    lead: "Barcelona na kilka dni z Warszawy: oferty Tripowni, loty, hotele i pakiety lot + hotel.",
    query: "Barcelona",
    kiwiCode: "BCN",
    departure: "Warszawa",
    departureCode: "WAW",
  ...
  },
  {
    ...
    lead: "Najtańsze krótkie wyjazdy z bazy Tripowni. Filtrujemy aktywne propozycje do 1000 zł za osobę.",
    query: "City break",
  ...
  },
  {
    ...
    lead: "Krótkie wyjazdy do 1500 zł za osobę — aktualne oferty Tripowni i szybkie porównanie partnerów.",
    query: "City break",
  ...
  },
  {
    ...
    lead: "Wakacje i city breaki z Krakowa-Balic: aktywne propozycje Tripowni oraz wyszukiwanie u partnerów.",
    query: "Wakacje",
    departure: "Kraków",
    departureCode: "KRK",
  ...
  },
  {
    ...
    title: "Last minute z Krakowa — wakacje i All Inclusive z Balic (KRK)",
    eyebrow: "LAST MINUTE Z KRAKOWA / BALIC",
    lead: "Last minute z Krakowa-Balic (KRK): aktualne wakacje, All Inclusive, czartery i ciepłe kierunki na najbliższe terminy.",
    query: "Last Minute",
    departure: "Kraków",
    departureCode: "KRK",
    categoryKeywords: ["plaza", "cieplo", "allinclusive"],
  ...
  },
  {
    ...
    title: "Last minute z Katowic — loty, wakacje i All Inclusive z KTW",
    eyebrow: "LAST MINUTE Z KATOWIC / PYRZOWIC",
    lead: "Last minute z Katowic-Pyrzowic (KTW): aktualne wakacje, loty czarterowe, All Inclusive i ciepłe kierunki na najbliższe terminy.",
    query: "Last Minute",
    departure: "Katowice",
    departureCode: "KTW",
    categoryKeywords: ["plaza", "cieplo", "allinclusive"],
  ...
  },
  {
    ...
    title: "All Inclusive z Krakowa — wakacje z wylotem z KRK",
    eyebrow: "ALL INCLUSIVE Z KRAKOWA / BALIC",
    lead: "All Inclusive z Krakowa-Balic (KRK): aktualne wakacje z lotem, hotelem i wyżywieniem. Porównaj ciepłe kierunki i pełny koszt pakietu.",
    query: "All Inclusive",
    departure: "Kraków",
    departureCode: "KRK",
    categoryKeywords: ["allinclusive", "plaza", "cieplo"],
  ...
  },
  {
    ...
    title: "All Inclusive z Katowic — wakacje z wylotem z KTW",
    eyebrow: "ALL INCLUSIVE Z KATOWIC / PYRZOWIC",
    lead: "All Inclusive z Katowic-Pyrzowic (KTW): aktualne pakiety z lotem, hotelem i wyżywieniem. Porównaj popularne kierunki i pełny koszt wakacji.",
    query: "All Inclusive",
    departure: "Katowice",
    departureCode: "KTW",
    categoryKeywords: ["allinclusive", "plaza", "cieplo"],
  ...
  },
  {
    ...
    title: "City break z Krakowa — tani weekend i lot + hotel z KRK",
    eyebrow: "CITY BREAK Z KRAKOWA / BALIC",
    lead: "City break z Krakowa-Balic (KRK): tani weekend, lot + hotel i krótkie wyjazdy na 2–5 dni. Porównaj kierunki i pełny koszt podróży.",
    query: "City break",
    departure: "Kraków",
    departureCode: "KRK",
    categoryKeywords: ["city", "weekend", "tanio"],
