...
export function getLinkMatch(offer: Offer): "exact" | "parameters" | "destination" | "unsafe" {
  ...
  if (offer.partner === "esky" || offer.partner === "kiwi") return "parameters";
