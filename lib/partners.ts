...
function buildTradeDoublerDeepLink({
  ...
  const params = new URLSearchParams({ p: programId, a: siteId, url: destinationUrl });
  return `${host}?${params.toString()}`;
}

function buildKiwiAffiliateUrl(destinationUrl?: string) {
...
export const partners: Record<PartnerKey, Partner> = {
  ...
  tui: {
    ...
    buildUrl: (destinationUrl = "https://www.tui.pl/") =>
      buildTradeDoublerDeepLink({ programId: "308388", siteId: "3487177", destinationUrl }),
  },
  getyourguide: {
    key: "getyourguide",
    name: "GetYourGuide",
    ...
    buildUrl: (destinationUrl = "https://www.getyourguide.pl/") =>
      buildTradeDoublerDeepLink({ programId: "356307", siteId: "3487177", destinationUrl }),
  },
  seeplaces: {
    key: "seeplaces",
    name: "SeePlaces",
  ...
  fonia: {
    ...
    buildUrl: (destinationUrl = "https://fonia.app/") =>
      buildTradeDoublerDeepLink({ programId: "373994", siteId: "3487177", destinationUrl }),
  },
  kiwi: {
    key: "kiwi",
    name: "Kiwi.com",
