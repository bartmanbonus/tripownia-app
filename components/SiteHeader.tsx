...
export default function SiteHeader() {
  ...
  return <>
    ...
    <header className="nav shell site-nav">
      <Link className="brand-logo" href="/" aria-label="Tripownia.pl"><Image src="/tripownia-logo.webp" alt="Tripownia.pl" width={220} height={220} priority /></Link>
      <nav className="site-nav-main">
        ...
        <details className="nav-more">
          ...
          <div className="nav-more-menu">
            ...
            <Link href="/podroze">Pomysły na wyjazd</Link>
