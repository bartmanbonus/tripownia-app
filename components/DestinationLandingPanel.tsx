...
const DESTINATIONS: Record<string, DestinationLandingConfig> = {
  "/wyspy-kanaryjskie-wakacje-all-inclusive-i-last-minute": {
    ...
    title: "Kanary bez przeklikiwania się przez poradnik",
    lead: "Najpierw wybierz wyspę albo ustaw własne daty. Poniżej masz wyszukiwarkę, konkretne propozycje i bezpośrednie przejście do ofert wakacyjnych.",
