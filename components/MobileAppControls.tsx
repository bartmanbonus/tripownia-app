...
export default function MobileAppControls() {
  ...
  const nav = [
    ...
    { href: "/moje-podroze", label: "Planner", icon: MapPinned, active: pathname.startsWith("/moja-podroz") || pathname.startsWith("/moje-podroze") || pathname.startsWith("/dodaj-podroz") || pathname.startsWith("/organizer") },
