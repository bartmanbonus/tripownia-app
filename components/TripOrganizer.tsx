    ...
    <section className="trip-organizer" aria-label={`Organizer podróży do ${city}`}>
      <div className="trip-organizer-head">
        <div>
          ...
          <p>Dane są przypisane do tej konkretnej podróży. Lokalnie działają bez konta, a po ręcznej synchronizacji konta mogą zostać przeniesione na inne urządzenie.</p>
        </div>
